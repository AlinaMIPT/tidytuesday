...
gg_record(dir = "2024/2024-11-12/plot", device = "png", width = 10, height = 8.5, units = "in", dpi = 320)

# Using 2024 data, downloaded from https://www.cia.gov/the-world-factbook/
cia_exp <- read_csv(here::here("2024/2024-11-12/data/Life expectancy at birth.csv")) %>% 
  select(name, life_exp_at_birth = years, region)

cia_pop <- read_csv(here::here("2024/2024-11-12/data/Population - total.csv")) %>% 
